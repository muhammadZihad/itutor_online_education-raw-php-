...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2019 at 10:33 AM
...
(26, 31, 26, 'Thanks', '2019-04-08 04:10:28');
...
INSERT INTO `pending` (`serial`, `u_id`) VALUES
(3, 31);
...
(28, 'Zihad', 'ae1ae3e0382d657c8fa94691892615a5', 'zihad@gmail.com', 0, 'KPS12', 1, 'img/user/28.jpg'),
(29, 'Saleheen', '2cd66b7983e843b20428b4659b0d5142', 'saleheen@gmail.com', 0, 'S1OF0', 1, 'img/user/default_user.jpg'),
(31, 'Tanim', '61e0cefbfb47c7d64ca22d50c554bd11', 'tanim@gmail.com', 0, 'Q2J8W', 0, 'img/user/default_user.jpg');
...
--
ALTER TABLE `comments`
  MODIFY `c_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
